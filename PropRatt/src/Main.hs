...
main = do
    ...
    print (evaluate (Always (Or (Or (Now ((Index First) ==== (Index Second))) (Now ((Index First) ==== (Index Third)))) (Now ((interleaveFunc <$> (Index Second) <*> (Index Third)) ==== (Index First))))) signalsUnderTest5)
